...
class ChatPage extends React.Component {
  ...
  render() {
    ...
    const isFromScreen = navigation.getParam !== undefined
      ? navigation.getParam('isFromScreen') : false;
    ...
    return (
      <View style={{ flex: 1 }}>
        {/* {!isFromScreen &&
          <LinearGradient
            style={[styles.header, {
              height: isIphone14 ? 76 : (isIphone14Pro ? 86 : 56) + Constants.statusBarHeight
            }]}
            ...
            <View style={{ marginVertical: 20, flexDirection: 'row', alignItems: 'center' }}>
              ...
              <TextInput
                ...
                onFocus={() => {
                  ...
                  Animated.timing(this.state.stickersHeight, {
                    toValue: this.state.inputHeight - height / 10,
                    duration: 250,
                    easing: Easing.linear,
                  }).start();
                }}
